...
class Lab_comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "PimerFlujograma", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PimerFlujograma")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, Frecuency, amplitud, 0, 0)

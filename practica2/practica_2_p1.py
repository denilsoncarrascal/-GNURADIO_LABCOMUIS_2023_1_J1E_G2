...
class practica_2_p1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica_2_p1")
        ...
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "frecuencia cortadora", "counter_slider", float, QtCore.Qt.Horizontal)
...
def main(top_block_cls=practica_2_p1, options=None):
